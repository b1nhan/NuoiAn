  ...
  return (
    <div className="min-h-screen font-sans selection:bg-brand-coral/30">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[5%] w-[30%] h-[30%] bg-purple-200/20 blur-[100px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#about" className="text-sm font-medium text-slate-600 hover:text-brand-coral transition-colors">Về Nuôi An</a>
            <a href="#why" className="text-sm font-medium text-slate-600 hover:text-brand-coral transition-colors">Lý do</a>
            <a href="#faq" className="text-sm font-medium text-slate-600 hover:text-brand-coral transition-colors">Hỏi đáp</a>
            <ShimmerButton 
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-6 items-center">
              <a href="#about" onClick={() => setMobileMenuOpen(false)} className="text-xl font-medium">Về Nuôi An</a>
              <a href="#why" onClick={() => setMobileMenuOpen(false)} className="text-xl font-medium">Lý do</a>
              <a href="#faq" onClick={() => setMobileMenuOpen(false)} className="text-xl font-medium">Hỏi đáp</a>
              <button 
                onClick={() => {
                  scrollToDonate();
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
        <Particles quantity={100} className="absolute inset-0" color="#ff6a88" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <span className="text-xs font-semibold text-brand-coral uppercase tracking-wider">{Content.HERO.badge}</span>
          </motion.div>
          ...
          >
            <span className="block text-slate-900">Nuôi An — Dự án nuôi sống</span>
            <span className="gradient-text pb-2">một con người</span>
          </motion.h1>
        ...
        {/* Floating Emojis */}
        <div className="absolute top-1/4 left-10 text-4xl animate-bounce hidden lg:block" style={{ animationDuration: '3s' }}>☕</div>
        <div className="absolute top-1/3 right-10 text-4xl animate-bounce hidden lg:block" style={{ animationDuration: '4s', animationDelay: '1s' }}>🌱</div>
        <div className="absolute bottom-1/4 left-20 text-4xl animate-bounce hidden lg:block" style={{ animationDuration: '2.5s', animationDelay: '0.5s' }}>💛</div>
        <div className="absolute bottom-1/3 right-20 text-4xl animate-bounce hidden lg:block" style={{ animationDuration: '3.5s', animationDelay: '1.5s' }}>✨</div>
      </section>
          ...
          >
            <div className="relative w-80 h-96">
              ...
              <div className="absolute inset-0 glass rounded-3xl p-8 flex flex-col items-center justify-center text-center shadow-2xl">
                <div className="w-40 h-40 bg-gradient-to-tr from-brand-peach to-brand-coral rounded-full flex items-center justify-center text-8xl mb-8 shadow-xl">
                  👨‍💻
                </div>
                <h3 className="text-2xl font-bold text-slate-900 mb-2">An là ai?</h3>
                <p className="text-slate-600">Một con người bằng xương bằng thịt, đang gõ code và mỉm cười với bạn.</p>
                <div className="mt-8 flex gap-3">
                  <div className="w-8 h-8 rounded-lg glass flex items-center justify-center text-brand-coral border-brand-coral/20 border"><Coffee className="w-4 h-4" /></div>
                  <div className="w-8 h-8 rounded-lg glass flex items-center justify-center text-brand-coral border-brand-coral/20 border"><Send className="w-4 h-4" /></div>
                  <div className="w-8 h-8 rounded-lg glass flex items-center justify-center text-brand-coral border-brand-coral/20 border"><Heart className="w-4 h-4" /></div>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section id="why" className="py-24 px-6 bg-slate-50/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold text-slate-900 mb-4 tracking-tight uppercase tracking-[0.1em]">Tại sao lại ủng hộ?</h2>
            <p className="text-slate-600 text-lg">Những lý do hoàn toàn thật lòng (và hơi thực tế).</p>
          </div>
      ...
      <section id="donate" className="py-24 px-6 relative">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 text-lg">Sự tử tế của bạn bắt đầu từ đây.</p>
          </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="glass rounded-[3rem] overflow-hidden p-8 md:p-12 shadow-2xl relative border-white/40">
              <BorderBeam size={300} duration={15} colorFrom="#ff6a88" colorTo="#ff9a8b" />
                  ...
                  <div className="relative w-full aspect-square max-w-[320px] glass rounded-3xl border-slate-200 border-2 overflow-hidden flex items-center justify-center">
                    {loading ? (
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-slate-400 font-medium">Đang tạo mã...</p>
                      </div>
                    ) : qrUrl ? (
                      <motion.img 
                        initial={{ opacity: 0, scale: 0.9 }}
                    ...
                    >
                      <div className="glass rounded-xl p-4 flex items-center justify-between border-slate-100 border bg-white">
                        <div className="space-y-1">
                          ...
                          <p className="text-xl font-bold text-brand-coral">{Number(amount).toLocaleString('vi-VN')} đ</p>
                        </div>
                        <div className="space-y-1 text-right">
                          <p className="text-xs font-bold text-slate-400 uppercase">Ngân hàng</p>
                          <p className="text-lg font-bold text-slate-700">{Content.BANK_CONFIG.BANK_ID}</p>
                        </div>
                      </div>

                      <div className="group relative">
                        <button 
                          onClick={() => copyToClipboard(note || "Nuoi An Donation")}
                        ...
                        >
                          <span className="text-slate-600 truncate mr-4">ND: {note || "Nuoi An Donation"}</span>
      ...
      <section id="faq" className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">Câu hỏi thường gặp</h2>
            <p className="text-slate-600">Mọi thứ bạn cần biết về Nuôi An.</p>
          </div>

          <Accordion type="single" collapsible className="w-full space-y-4">
            {Content.FAQ_DATA.map((faq, idx) => (
              <AccordionItem key={idx} value={`item-${idx}`} className="border-b border-slate-100 px-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-[3rem] bg-gradient-to-r from-brand-coral to-brand-peach p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-6xl font-black mb-6">Cảm ơn bạn đã ghé thăm 💛</h2>
              <p className="text-xl md:text-2xl mb-12 opacity-90 max-w-2xl mx-auto leading-relaxed">
                Dù bạn có ủng hộ hay không — việc bạn đọc đến đây đã là điều tuyệt vời rồi.
              </p>
              <button 
                onClick={scrollToDonate}
                className="inline-flex items-center justify-center h-16 px-12 rounded-2xl bg-white text-brand-coral text-xl font-bold hover:scale-105 transition-transform shadow-xl"
              >
                Ủng hộ An ngay
              </button>
            </div>
      ...
      <footer className="py-12 px-6 border-t border-slate-100">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left space-y-2">
            <p className="text-xl font-bold gradient-text">{Content.NAVBAR.logo}</p>
            <p className="text-slate-400 font-medium">{Content.FOOTER.tagline}</p>
          </div>
